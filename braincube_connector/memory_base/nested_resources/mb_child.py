...
class MbChild(base_entity.BaseEntity):
    ...
    def __init__(self, bcid, name, metadata, path, memory_base, **kwargs):
        ...
        """
        self.initialize(bcid, name, metadata, path, memory_base, **kwargs)

    def initialize(self, bcid, name, metadata, path, memory_base, **kwargs):
        """Initialize a memory bases child.
